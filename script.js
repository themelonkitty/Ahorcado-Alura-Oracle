...
let palabras = ["GATITA","DULCE","PURPURA","MIRADA","CALENDARIO","GEOMETRIA","MEGALOMANIACO"];
let palabraSecreta = "";
...
/* Creo la funcion hideMenuAgregarPalaraeIniciar para esconder los elementos del menú de agregar palabra, y la funcion addPalabraTexto añade la palabra del cuadro de texto al array de donde se escogerá la palabra secreta, ademas ejecutiva la funcion ya mencionada y también esconde los botones de inicio.  */
...
también va a hacer visibles los botones del tablero de juego, el tablero, sorteara una palabra secreta y dibujará la horca y los espacios de cada letra */
...
/* La función "showBotonIniciar va a mostrar los botones de inicio,
también va a hacer invisibles los botones del tablero de juego */
...
/* La función va a evitar que el programa reconozca teclas de mando al juagr */
function omitirflechas(flecha){
   if(flecha == "ARROWRIGHT" || flecha == "ARROWUP" || flecha == "ARROWDOWN" || flecha == "ARROWLEFT" || flecha == "ENTER" || flecha == "BACKSPACE" || flecha =="SHIFT" || flecha =="CAPSLOCK" || flecha == "TAB" || flecha =="CONTROL" || flecha =="ALT" || flecha =="ESCAPE" || flecha == "NUMLOCK" || flecha =="META"|| flecha =="DEAD"|| flecha =="DELETE" || flecha =="HOME" || flecha =="END" || flecha =="PAGEUP"|| flecha =="PAGEDOWN"){
      return false;
...
/*Obtiene la letra presionada por el usuario, la hace mayuscula y la compara con cada letra de la palabra secreta, si son iguales, escribe true en la consola */
let vidas = 0
let victoria = 0
historial = []
historialletrascorrectas=[]
...
function obtenerTeclaPresionada (e) {
